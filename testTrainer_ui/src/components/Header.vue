<template>
  <q-header dark reveal elevated class="text-white row">
    <div class="q-gutter-y-sm q-gutter-x-sm col" v-if="$q.platform.is.desktop">
      <q-tabs dark align="left" inline-label class="float-left tabbar">
      ...
      <q-tabs align="right" inline-label class="float-right tabbar" stretch>
        <q-route-tab
          v-if="!loggedIn"
          name="login"
          to="/login"
        ...
        >
          <q-list>
            <q-item clickable @click="tab = 'more'">
              <q-route-tab v-if="loggedIn" to="/userinfo" label="Áskrift/Stillingar" />
            </q-item>
...
<!-- MOBILE -->
    ...
    <div class="absolute-full flex" v-if="$q.platform.is.mobile">
      <q-toolbar class="text-white bg-primary flex">
        ...
        <q-tabs
          ...
          stretch
        >
          <q-btn-dropdown auto-close stretch flat name="more" icon="menu">
            <q-list>
              <q-item v-if="!loggedIn" clickable @click="tab = 'more'">
                <q-route-tab
                  name="login"
                  to="/login"
                  label="Innskrá"
              ...
              <q-item v-if="loggedIn" clickable @click="tab = 'more'">
                <q-route-tab dark to="/createtest" label="Æfing" />
              </q-item>

              <q-item v-if="loggedIn" clickable @click="tab = 'more'">
                <q-route-tab dark to="/testreal" label="Próf" />
              </q-item>

              <q-item v-if="loggedIn" clickable @click="tab = 'more'">
                <q-route-tab dark to="/flipcard" label="Flettikort" />
              </q-item>

              <q-item v-if="loggedIn" clickable @click="tab = 'more'">
                <q-route-tab to="/dashboard/allt" label="Mælaborð" />
              </q-item>
                          <q-item clickable @click="tab = 'more'">
              <q-route-tab v-if="loggedIn" to="/userinfo" label="Áskrift/Stillingar" />
            </q-item>
              ...
              <q-item v-if="loggedIn" clickable @click="tab = 'more'">
                <q-route-tab to="/about" label="Um vefinn" />
              </q-item>
